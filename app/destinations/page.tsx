    ...
    <main className="bg-[#fff8ee] text-[#2b1b11]">
      <section className="px-5 pb-14 pt-28 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-7xl">
          <p className="premium-eyebrow">Dynamic destinations</p>
          <div className="mt-5 grid gap-8 lg:grid-cols-[0.9fr_1fr] lg:items-end">
            <h1 className="display-font text-6xl font-semibold leading-[0.95] tracking-[-0.05em] md:text-8xl">
              Morocco places you can shape into a private journey.
            </h1>
            <p className="max-w-2xl text-lg leading-8 text-[#75675d]">
              These destination pages come from your PHP admin. Add or edit a page there,
              and it appears here automatically with a premium layout.
            </p>
          </div>
        </div>
      </section>
          ...
          {pages.length ? (
            pages.map((page, index) => {
              ...
              const text =
                ...
                page.hero_subtitle ||
                "A private Morocco destination page edited from your admin.";
            ...
            <div className="col-span-full rounded-[2rem] border border-[#eadbc8] bg-white p-10 text-[#75675d]">
              No destination pages found yet. In the PHP admin, create a page with page type
              <strong> hub</strong>.
            </div>
          )}
        </div>
